	...
	export default {
		...
		data() {
			return {
				...
				inquiryOrderMenu: [
					{img: 'icon-quanbudingdan-xingerenzhongxin', title: '\u5168\u90e8', url: '/pages/users/inquiry_order_list/index', num: 4},
					{img: 'icon-daifukuan-xingerenzhongxin', title: '\u5f85\u652f\u4ed8', url: '/pages/users/inquiry_order_list/index?status=0', num: 1},
					{img: 'icon-daifahuo-xingerenzhongxin', title: '\u5f85\u53d1\u8d27', url: '/pages/users/inquiry_order_list/index?status=1', num: 1},
					{img: 'icon-baoguo_shouhuo_o', iconClass: 'inquiry-receive-icon', title: '\u5f85\u6536\u8d27', url: '/pages/users/inquiry_order_list/index?status=2', num: 1},
					{img: 'icon-duihao', iconClass: 'inquiry-complete-icon', title: '\u5df2\u5b8c\u6210', url: '/pages/users/inquiry_order_list/index?status=4', num: 1},
				],
				imgUrls: [],
				userMenu: [],
				autoplay: true,
