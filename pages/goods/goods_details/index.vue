...
<script>
	...
	import productConSwiper from '@/pages/goods/components/productConSwiper';
	import couponListWindow from '@/pages/goods/components/couponListWindow';
	import productWindow from '@/components/productWindow';
	import userEvaluation from '@/pages/goods/components/userEvaluation';
	import shareRedPackets from '@/pages/goods/components/shareRedPackets';
	import cusPreviewImg from '@/pages/goods/components/cus-previewImg/cus-previewImg.vue'
	import {
		silenceBindingSpread
	} from "@/utils";
	import parser from "@/pages/goods/components/jyf-parser/jyf-parser";
	import {
		computeUser
	} from "@/api/user.js";
	// #ifdef MP
