...
<script>
	...
	import productConSwiper from '@/pages/activity/components/productConSwiper/index.vue'
	import productWindow from '@/components/productWindow/index.vue'
	import userEvaluation from '@/pages/activity/components/userEvaluation/index.vue'
	import cusPreviewImg from '@/pages/activity/components/cus-previewImg/cus-previewImg.vue'
	// #ifdef MP
	import {
		base64src
	...
	// #endif
	import parser from "@/pages/activity/components/jyf-parser/jyf-parser";
	// import countDown from '@/components/countDown';
	import countDown from "@/pages/activity/components/countDown";
	import shareRedPackets from '@/pages/activity/components/shareRedPackets';
	import {
		imageBase64
	} from "@/api/public";
	import {
