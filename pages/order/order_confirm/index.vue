			...
			<view class="pad30">
				...
				<view class='wrapper borRadius14'>
					...
					<view class='item acea-row row-between-wrapper'
						v-if="false && !orderInfoVo.bargainId && !orderInfoVo.combinationId && !orderInfoVo.seckillId && productType==='normal'">
						<view>积分抵扣</view>
...
<script>
	...
	import couponListWindow from '@/pages/order/components/couponListWindow';
