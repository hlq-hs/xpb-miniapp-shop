 ...
 * @param {string} phone
 */
export function getSettlementRepairInfo(phone){
  return request.get('user/getSettlementRepairInfo', { phone }, { noAuth : true });
}
 ...
 * @param {string|number} shopId
 */
export function getRepairDetailInfo(jobNo, shopId){
  return request.get('user/getRepairDetailInfo', { jobNo, shopId }, { noAuth : true });
}
